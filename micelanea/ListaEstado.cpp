...
ListaEstado::ListaEstado(){
 ...
 void ListaEstado::SetLista(QTableWidget *w_Lista){ Lista=w_Lista;}

 void ListaEstado::SetItem(int w_Item){Item=w_Item;}
...
int ListaEstado::Rojo(){
    ...
    int Rojo=brush.color().red();
        ...
        for(int i=0; i != Lista->rowCount(); ++i){
            if(Lista->item(i,0)->background().color().red()==Rojo){ return(i);}
            }
...
int ListaEstado::Verde(){
    ...
    int Verde=brush.color().green();
        ...
        for(int i=0; i != Lista->rowCount(); ++i){
            if(Lista->item(i,0)->background().color().green()==Verde){ return(i);}
            }
