...
void PlayerPisadores::EstablecerIn(){
  ...
  QRadioButton *w_Radio = qobject_cast<QRadioButton *>(obj);
    ...
    if(w_Radio == this->RInHora || w_Radio == this->RInHumedad ||w_Radio == this->RInTemperatura){              //que bonito comprobando dos punteros, (no si son iguales) si es el mismo
        LInFichero->setEnabled(false);
        BtnInFichero->setEnabled(false);
        LInCarpeta->setEnabled(false);
        BtnInCarpeta->setEnabled(false);
...
void PlayerPisadores::EstablecerOut(){
  ...
  QRadioButton *w_Radio = qobject_cast<QRadioButton *>(obj);
    ...
    if(w_Radio == this->ROutFichero){              //que bonito comprobando dos punteros, (no si son iguales) si es el mismo
    ...
    if(w_Radio == this->ROutCarpeta){              //que bonito comprobando dos punteros, (no si son iguales) si es el mismo
    ...
    if(w_Radio == this->ROutHora || w_Radio == this->ROutHumedad ||w_Radio == this->ROutTemperatura){              //que bonito comprobando dos punteros, (no si son iguales) si es el mismo
        LOutFichero->setEnabled(false);
        BtnOutFichero->setEnabled(false);
        LOutCarpeta->setEnabled(false);
        BtnOutCarpeta->setEnabled(false);
