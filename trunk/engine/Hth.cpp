...
void Hth::StartHora(){
  ...
  // Path=QCoreApplication::applicationDirPath().toLatin1();
   ...
   if (playTime.minute()==0){    //hora en punto
...
//////////////////////////////////////////////////////////////////////////////
void Hth::StartHumedad(){         //locuta la humedad
     BASS_SetDevice(Dispositivo);    //dispositivo
    ...
    QFile file(Path.toLatin1() + "/Currenweather/currenweather.txt");
       if (!file.open( QIODevice::ReadOnly| QIODevice::Text))
        ...
        bool MenosCero=false;
         ...
         if(tempo<10){Temperatura= "0" + Temperatura;}

         Temperatura= "0" + Temperatura;

        if(MenosCero){Temperatura= "N" + Temperatura;}
        ...
        // qDebug() <<Humedad;
         ...
         if(tempo<10){Humedad = "0" + Humedad;}
         if(tempo !=100){Humedad = "0" +Humedad;}
