...
void PlayerGrupos::setRotacion(QString Url){
  ...
  File.close();
      ...
      Lista->setCurrentCell(0,0); //Nos posicionamos arriba
...
///////////////////////////////////////////////////////////////////////////////////////
 ...
 if(w_FileInfo.suffix().toLower()=="seq"||w_FileInfo.suffix().toLower()=="tad" ){  //grupos
    setRojo();
    PlayGrupos(url);
    return;
...
//===========================================================
     ...
     if(IsTanda){return;}  // si es tanda no soparta pisadores
...
void PlayerGrupos::PlayGrupos(QString Url){
 ...
 QFileInfo w_FileInfo(Url);
    ...
    if(w_FileInfo.suffix().toLower()=="tad"){ // si es tanda quitamos mezcla
