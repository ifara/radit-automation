...
ListaEventos::ListaEventos(QWidget *parent): QTableWidget(parent)
...
void ListaEventos::resizeEvent( QResizeEvent *event){
   ...
   this->setColumnHidden(5, true);  //ocultamos columnas segundos
   this->setColumnHidden(6, true);  //ocultamos columnas fichero
   this->setColumnHidden(7, true);  //ocultamos columnas COD
   this->setColumnHidden(8, true);  //ocultamos columnas fechahora
}
