    ...
    :QDialog(parent)
{
  ...
  //Editor cuñas ***********************************************
  connect(BtnEditar, SIGNAL(clicked()), this, SLOT(ShowEditorCunas())); // Editor cuñas

//*************** botones
  connect(Btn1, SIGNAL(clicked()), this, SLOT(clickBoton())); // Editor cuñas
  connect(Btn2, SIGNAL(clicked()), this, SLOT(clickBoton())); // Editor cuñas
  connect(Btn3, SIGNAL(clicked()), this, SLOT(clickBoton())); // Editor cuñas
  connect(Btn4, SIGNAL(clicked()), this, SLOT(clickBoton())); // Editor cuñas
  connect(Btn5, SIGNAL(clicked()), this, SLOT(clickBoton())); // Editor cuñas
  connect(Btn6, SIGNAL(clicked()), this, SLOT(clickBoton())); // Editor cuñas
  connect(Btn7, SIGNAL(clicked()), this, SLOT(clickBoton())); // Editor cuñas
  connect(Btn8, SIGNAL(clicked()), this, SLOT(clickBoton())); // Editor cuñas
  connect(Btn9, SIGNAL(clicked()), this, SLOT(clickBoton())); // Editor cuñas
...
if(!Boton->isChecked()){
    delete Boton->SetPisadore;  //hace stop
     Boton->SetPisadore=NULL;
     BotonColor(Boton,false); // quita verde
    return;
}
...
w_Pisadores->Start();
BotonColor(Boton,true); // lo pone verde
...
void Cunas::BotonColor(QPushButton *boton, bool verde){
    ...
    boton->setStyleSheet(QString::fromUtf8(   //verde
...
///////////////////////////////////////////////////////
void Cunas::Llenar(){  //crea las cuñas vacias
